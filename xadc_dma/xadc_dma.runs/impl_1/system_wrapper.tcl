...
set rc [catch {
  ...
  set_property webtalk.parent_dir E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.cache/wt [current_project]
  set_property parent.project_path E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.xpr [current_project]
  set_property ip_repo_paths E:/zybo_base_system/source/vivado/hw/lib [current_project]
  set_property ip_output_repo E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.srcs/sources_1/bd/system/system.bd
  set_property is_locked true [get_files E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.srcs/sources_1/bd/system/system.bd]
  set_param project.isImplRun false
  read_xdc E:/vivado_hardware_design/Base_Linux_System_DMA/Base_Linux_System_DMA.srcs/constrs_1/new/base.xdc
  set_param project.isImplRun true
